...
@implementation MockPuzzleVerifyView (PatternPathProvider)

+ (UIBezierPath *)verifyPathForPattern:(MockPuzzleVerifyPattern)pattern {
    switch (pattern) {
        case MockPuzzleVerifyClassicPattern:
            return [self classicPuzzlePath];
        case MockPuzzleVerifySquarePattern:
            return [self squarePath];
        case MockPuzzleVerifyCirclePattern:
            return [self circlePath];
        case MockPuzzleVerifyCustomPattern:
            return [self classicPuzzlePath];
    }
}
